...
function _0x382e() {
    const _0xea349f = ['.gìf', 'leaveGif', 'floor', '78064RBKQGj', '85tUCdFH', 'customLeave', 'onLoad', '𝙩ự 𝙧ờ𝙞', 'nodemodule', '36ZwKWwf', '𝙗ị 𝙦𝙪ả𝙣 𝙩𝙧ị 𝙫𝙞ê𝙣 đá', '245udigqB', 'config', 'sendMessage', 'HĐGN', '130hnCFLX', 'leftParticipantFbId', '109299XNBCrO', 'author', 'randomgif', '1.0.0', '💞 {name} 𝙫𝙞̀ 𝙠𝙝𝙤̂𝙣𝙜 𝙩𝙪̛𝙤̛𝙣𝙜 𝙩𝙖́𝙘 𝘽𝙤𝙭 𝙣𝙚̂𝙣 đ𝙖̃ {type} 𝙠𝙝𝙤̉𝙞 𝙣𝙝𝙤́𝙢🐳, 𝙑𝙞̃𝙣𝙝 𝙗𝙞𝙚̣̂𝙩 𝙚𝙢 𝙣𝙝𝙚́ ❤', 'getCurrentUserID', 'undefined', 'data', '41960JIOJoP', '36ZcDwMy', 'threadData', 'logMessageData', 'log:unsubscribe', 'path', 'getNameUser', 'cache', 'exports', 'replace', 'run', '9111mqPxia', 'random', '248652jAXEzJ', '2846040HCHaek', '2551571QKMSbP', 'length'];
    _0x382e = function () {
        return _0xea349f;
    };
    return _0x382e();
