    ...
    switch (args[0]) {
        ...
        case '-r': {
            ...
            if (!existsSync(pathData)) {
                ...
                return api.sendMessage("🔱 Đăng ký thành công tiến vào đấu trường", threadID, messageID);
