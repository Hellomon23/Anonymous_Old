...
var coinsdd = Math.floor(Math.random() * 201) + 5000; //random coins khi đào đá
...
var work6 = rddd1[Math.floor(Math.random() * rddd1.length)];
  ...
  var rdex1 = ['1 tuần trên sa mạc', '1 tuần không ngủ', 'ăn đồ ăn của chó', '7 ngày không ỉa', 'uống nước đái mèo', 'ăn phân dê']; //random công việc khi thử thách 
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(event.body) {
                ...
                case "7": msg = `Bạn nhận được thử thách ${work7} và bạn đã nhận được ${coinsex1}$ `; await Currencies.increaseMoney(event.senderID, parseInt(coinsex1)); break;
            };
