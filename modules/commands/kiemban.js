module.exports.config = {
  ...
  module.exports.run = async ({ api, event,args, Users }) => {
   const axios = global.nodemodule["axios"];
    ...
    if (!args[0]) {
              ...
              console.log(data)
              if (data.length == 0) return api.sendMessage("Rất tiếc! Không tìm thấy người hợp với bạn 😥", event.threadID, event.messageID);
  ...
  `, { responseType: "arraybuffer" } )).data; 
              ...
              api.sendMessage({ body: `🔎Tìm bạn🔍\n😈Tên: ${n}\n💗Tỉ lệ thân nhau: ${a.toFixed(2)}%\n✨ID: ${e}\n🐳Ảnh của người đó:`,
